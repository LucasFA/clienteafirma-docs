...
style="width:4.41732in;height:3.12598in" />
...
style="width:5.43307in;height:1.16929in" />
...
-   General:
    ...
    -   Habilitar opciones de configuración avanzadas
        ...
        Esta opción habilita la vista y opciones avanzadas de la
...
-   Firmas de documentos PDF:
    ...
    -   Lugar donde se realiza la firma electrónica.
        ...
        Establece la localización asociada a las firmas PDF que se
        generen.
...
-   Perfiles
    ...
    -   Perfiles disponibles
        ...
        asociado valores para cada una de las opciones de configuración
        de las pestañas General, Contexto de firma y Accesibilidad de la
        ventana de opciones.
    ...
    -   Eliminar
        ...
        Elimina el perfil seleccionado. Se pedirá confirmación al
        usuario antes de proceder a la eliminación.
...
-   Guardar
    ...
    actual de usuario. Si el perfil actual es el Predeterminado, se
    creará un nuevo perfil tal como ocurriría con la opción Guardar
    como.

    -   Guardar como

        Crea un nuevo perfil de usuario con las opciones de
        configuración establecidas actualmente. Se le pedirá al usuario
        que inserte el nombre del nuevo perfil.
...
-   Formato:
    ...
    -   Permite seleccionar el formato de firma electrónica. Los
        ...
        -   OOXML (Office Open XML): Formato de firma de documentos
...
-   Tipo de multifirma
    ...
    -   Agregar nueva firma (Cofirma): Permite agregar nuevas firmas a
        un documento de firmas. En el caso de las firmas PDF, ODF y
        OOXML. Para agregar nuevas firmas al documento basta con
        firmarlo múltiples veces a través de la pestaña “Firma” de la
        interfaz.

    -   Refrendar una firma (Contrafirma): Permite firmar firmas
        anteriores de un documento de firmas.

        Al pulsar el botón “Firmar” se abrirá un asistente para la
        generación de la multifirma. Este asistente variará según se
        haya decidido realizar una cofirma o una contrafirma.
...
style="width:4.17323in;height:3.64173in" />

Al pulsar el botón “Siguiente &gt;” accederemos a la primera pantalla
del asistente, en donde deberemos seleccionar el documento que deseamos
...
-   Opciones de la firma por lotes
    ...
    -   Alerta sonora al finalizar el proceso: Utiliza el *beep* del
        sistema para emitir un sonido una vez finaliza el proceso de
        firma masiva.
...
Al pulsa el botón “Siguiente &gt;”, nos aparece una nueva ventana donde
se nos explica el proceso según la operación de firma seleccionada y se
nos permite configurar tanto esta como el formato de firma.
...
-   Operación predeterminada:
    ...
    -   Firma: Firna cada uno de los ficheros del lote usando el formato
        de firma seleccionado.

    -   Cofirma: Cofirma todos los ficheros de firma del lote y firmará
        con el formato seleccionado todos aquellos que no sean.
...
> style="width:4.625in;height:3.55208in" />
>
> <<img src="media/image52.png"
> style="width:4.875in;height:3.63542in" />
>
...
> style="width:4.66667in;height:3.64583in" />
>
...
> style="width:4.4375in;height:3.4375in" />
>
> <<img src="media/image55.png"
> style="width:2.98958in;height:2.71875in" />
>
...
> style="width:2.73958in;height:2.11458in" />
>
...
> style="width:4.75in;height:3.34375in" />
>
> <<img src="media/image59.png"
> style="width:4.75in;height:3.48958in" />
>
...
> style="width:5.60417in;height:3.94792in" />
>
...
-   En un entorno **Microsoft Windows**, el equipo debe tener instalado
    un servicio que se denomina "Cryptographic Service Provider" 
    **(CSP).**
...
> style="width:5.90625in;height:2.3125in" />
>
...
> style="width:5.90625in;height:2.88542in" />
>
> <<img src="media/image65.png"
> style="width:3.71875in;height:1.67708in" />
>
> Una vez descargado el fichero con la nomenclatura “DNIe_vx_j_y.zip” lo
> descomprimiremos y accederemos al fichero “DNIe_vx_j_y.exe”.
>
> El software se instalará automáticamente y se le pedirá reiniciar el
> equipo.
>
> <<img src="media/image66.png"
> style="width:4.375in;height:3.34375in" />
>
> <<img src="media/image67.png"
> style="width:4.375in;height:3.35417in" />
>
> Es posible, dependiendo de la configuración de su navegador, que nos
> aparezca la siguiente ventana:
>
> <<img src="media/image68.png"
> style="width:4.125in;height:3.85417in" />
>
...
>
> <<img src="media/image72.emf"
> style="width:5.125in;height:2.17708in" />
>
